...
///
/// Epoch twenty-nine adds the daemon-owned signed update-channel preference while
/// retaining Host Work, `SuperGrok`, and Search contracts from earlier epochs. The
/// Protobuf package remains the canonical v1 schema family; the envelope version
